...
export const KEYS: Array<Key> = [
    new Key('Amfiteatr im. Michaela Jacksona', 52.233631, 20.906177, 10, '100#2580', null),
    ...
    new Key('Targowa 6 Pruszków ', 52.1570786, 20.804121200000054, 10, 'S1236D', null),    
    ...
    new Key('Bohaterów Wolności 8 Piastów', 52.183391, 20.839458, 10, '#2580#', null),
    new Key('Władysława Jagiełły 33 Warszawa', 52.198303, 20.874907, 10, '100#2569', null),
    new Key('Żbikowska 6, Piastów', 52.189688, 20.836454, 10, 'Policjant K1834D', null),
    ...
    new Key('Adama Mickiewicza 17 Piastów', 52.179154, 20.838641, 10, '*01#0116#', null),
    new Key('Anielin 1 Pruszków', 52.166818, 20.807465, 10, '100#1410', null),
